    ...
    value: function _handleMessage(topic, message) {
      ...
      switch (parts[3]) {
        ...
        case 'up':
          ...
          break;
        case 'eui-a84041ced1839680':
          _get(Client.prototype.__proto__ || Object.getPrototypeOf(Client.prototype), 'emit', this).call(this, '_uplinkDevice680_', {
            payload: payload
          });
          break;
        case 'eui-a84041b491843938':
          _get(Client.prototype.__proto__ || Object.getPrototypeOf(Client.prototype), 'emit', this).call(this, '_uplinkDevice938_', {
            payload1: payload
          });
          break;
        case 'eui-a840413271843931':
          _get(Client.prototype.__proto__ || Object.getPrototypeOf(Client.prototype), 'emit', this).call(this, '_uplinkDevice931_', {
            payload2: payload
          });
          break;  
      }
